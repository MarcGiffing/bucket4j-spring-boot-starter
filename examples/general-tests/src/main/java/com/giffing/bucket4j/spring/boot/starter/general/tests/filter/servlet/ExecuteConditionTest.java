...
@SpringBootTest(properties = {
        ...
        "bucket4j.filters[0].rate-limits[0].execute-condition=getHeader('user') ne 'admin'",
...
@DirtiesContext
public class ExecuteConditionTest {
    ...
    void rate_limit_for_user_bilbo_in_header() throws Exception {
        for(long remainingTries = 5; remainingTries >= 1; remainingTries--) {
            mockMvc
                    .perform(get(TEST_URL)
