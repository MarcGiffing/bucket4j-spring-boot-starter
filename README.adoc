...
bucket4j.filters[0].metric-tags-strategy-keys=USERNAME,URL # see MetricTagStrategy | Micrometer tags  
...
TODO
https://github.com/MarcGiffing/bucket4j-spring-boot-starter-examples/tree/master/bucket4j-spring-boot-starter-example-ehcache[ehcache example with prometheus]
