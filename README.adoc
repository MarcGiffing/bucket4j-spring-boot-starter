...
Execution Predicates can be used to conditionally execute the rate limiting. Each predicate has a unique name and a self-contained configuration.
The following section describes the build in Execution Predicates and how to use them.

=== Path Execution Predicates

The Path Execution Predicate takes a list of path parameters where any of the paths must match to execute. 
...
=== Method Execution Predicate

The Method Execution Predicate takes a list of method parameters where any of the methods must match the used HTTP method.
...
=== Query Execution Predicate

The Query Execution Predicate takes a single parameter to check for the existence of the query parameter.
...
=== Header Execution Predicate

The Header Execution Predicate takes to parameters.
...
@Component
@Slf4j
public class MyQueryExecutePredicate extends ServletRequestExecutePredicate {
