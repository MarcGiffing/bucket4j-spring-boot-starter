...
bucket4j.filters[0].rate-limits[0].execute-predicates[0]=PATH=/hello # On the HTTP Path
bucket4j.filters[0].rate-limits[0].execute-predicates[1]=METHOD=/GET # On the HTTP Method
