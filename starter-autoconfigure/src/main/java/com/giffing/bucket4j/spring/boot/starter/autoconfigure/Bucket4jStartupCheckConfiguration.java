package com.giffing.bucket4j.spring.boot.starter.autoconfigure;
...
import static com.giffing.bucket4j.spring.boot.starter.core.utils.RateLimitAopUtils.getAnnotationFromMethodOrClass;
...
public class Bucket4jStartupCheckConfiguration {
    ...
    private void assertCacheConfiguration() {
        ...
        checkCacheResolverForFiltersIsRequired(asyncCacheResolver == null, filterMethods, Set.of(FilterMethod.WEBFLUX));
    }
